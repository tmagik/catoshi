...
* Update `src/litecoin/params.cpp` nMinimumChainWork with information from the getblockchaininfo rpc.
* Update `src/litecoin/params.cpp` defaultAssumeValid  with information from the getblockhash rpc.
