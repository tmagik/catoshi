TEMPLATE = app
VERSION = 1.9.0 #TODO should pull from version.h
...
# It would be nice if this worked right
#RESOURCES += \
#    src/qt/res/$${TARGET}.qrc
# so for now we cheat with symlinks
RESOURCES += src/qt/res/codecoin.qrc
