...
if __name__ == '__main__':
    ...
    parser.add_argument('--force', action='store_true', help='don\'t check whether catcoind is caught up')
    parser.add_argument('--testnet', action='store_true', help='use catcoin testnet addresses and block numbers')
    ...
    parser.add_argument('--rpc-connect', help='the hostname of the catcoind JSON-RPC server')
    parser.add_argument('--rpc-port', type=int, help='the port used to communicate with catcoind over JSON-RPC')
    parser.add_argument('--rpc-user', help='the username used to communicate with catcoind over JSON-RPC')
    parser.add_argument('--rpc-password', help='the password used to communicate with catcoind over JSON-RPC')
    ...
    parser_wallet = subparsers.add_parser('wallet', help='list the addresses in your catcoind wallet along with their balances in all Counterparty assets')
    ...
    if args.action == 'send':
        ...
        try:
            ...
            raise exceptions.InvalidAddressError('Invalid catcoin address:',
                                                  args.address)
