...
namespace Checkpoints {
     ...
     * 
     * 2017: FIXME: assumptions above need to be checked, verification
     * feels much much slower with sigcheck on recent Bitcoin chainsyncs
     */
    static const double SIGCHECK_VERIFICATION_FACTOR = 20.0;
    ...
    // TODO: use this infrastructure for Keyminer (two factor blockchain)
    //   Question: how to validate a chain download if one of the genesis
    //   block OP_ADDMINERKEYS associated private key is compromised? 
