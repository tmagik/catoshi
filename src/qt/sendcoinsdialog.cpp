...
void SendCoinsDialog::on_sendButton_clicked()
{
    ...
    foreach(const SendCoinsRecipient &rcp, recipients)
    {
        ...
        formatted.append(tr("<b>%1</b> to %2 (%3)").arg(CodecoinUnits::formatWithUnit(CodecoinUnits::CC, rcp.amount), Qt::escape(rcp.label), rcp.address));
#else
        formatted.append(tr("<b>%1</b> to %2 (%3)").arg(CodecoinUnits::formatWithUnit(CodecoinUnits::CC, rcp.amount), rcp.label.toHtmlEscaped(), rcp.address));
#endif
    }
