...
/* ... share this with Litecoin?? ... */
CAmount Bitcoin_PoWReward(int nHeight, const Consensus::Params& consensusParams)
{
...
int64_t CBlockIndex::GetSeigniorage(int64_t nFees, int64_t CoinAge) const
{
	...
	return Bitcoin_PoWReward(nHeight, Params().GetConsensus()) + nFees;
}
