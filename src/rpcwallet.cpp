...
Value getnewaddress(const Array& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "\nResult:\n"
            "\"" BRAND_upper "address\"    (string) The new " BRAND_upper " address\n"
            "\nExamples:\n"
...
Value getaccountaddress(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "\nResult:\n"
            "\"" BRAND_lower "address\"   (string) The " BRAND_upper " account address\n"
            "\nExamples:\n"
...
Value getrawchangeaddress(const Array& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "getrawchangeaddress\n"
            "\nReturns a new " BRAND_upper " address, for receiving change.\n"
...
Value setaccount(const Array& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "\nArguments:\n"
            "1. \"" BRAND_lower "address\"  (string, required) The " BRAND_lower " address to be associated with an account.\n"
...
Value getaccount(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "\nArguments:\n"
            "1. \"" BRAND_lower "address\"  (string, required) The " BRAND_lower " address for account lookup.\n"
            "\nResult:\n"
...
Value getaddressesbyaccount(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "  \"" BRAND_lower "address\"  (string) a " BRAND_lower " address associated with the given account\n"
            "  ,...\n"
            "]\n"
            "\nExamples:\n"
...
Value sendtoaddress(const Array& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 4)
        throw runtime_error(
            ...
            "\nArguments:\n"
            "1. \"" BRAND_lower "address\"  (string, required) The " BRAND_lower " address to send to.\n"
...
Value listaddressgroupings(const Array& params, bool fHelp)
{
    if (fHelp)
        throw runtime_error(
            ...
            "  [\n"
            "    [\n"
            "      \"" BRAND_lower "address\",     (string) The " BRAND_lower " address\n"
...
Value signmessage(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 2)
        throw runtime_error(
            ...
            + HelpRequiringPassphrase() + "\n"
            "\nArguments:\n"
            "1. \"" BRAND_lower "address\"  (string, required) The " BRAND_lower " address to use for the private key.\n"
...
Value getreceivedbyaddress(const Array& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            "getreceivedbyaddress \"" BRAND_lower "address\" ( minconf )\n"
            "\nReturns the total amount received by the given " BRAND_lower "address in transactions with at least minconf confirmations.\n"
            "\nArguments:\n"
            "1. \"" BRAND_lower "address\"  (string, required) The " BRAND_lower " address for transactions.\n"
...
Value getbalance(const Array& params, bool fHelp)
{
    if (fHelp || params.size() > 3)
        throw runtime_error(
            ...
            "\nResult:\n"
            "amount              (numeric) The total amount in " BRAND_CODE " received for this account.\n"
            "\nExamples:\n"
...
Value sendfrom(const Array& params, bool fHelp)
{
    if (fHelp || params.size() < 3 || params.size() > 6)
        throw runtime_error(
            "sendfrom \"fromaccount\" \"to" BRAND_lower "address\" amount ( minconf \"comment\" \"comment-to\" )\n"
            "\nSent an amount from an account to a " BRAND_lower " address.\n"
            "The amount is a real and is rounded to the nearest 0.00000001."
            + HelpRequiringPassphrase() + "\n"
            "\nArguments:\n"
            "1. \"fromaccount\"       (string, required) The name of the account to send funds from. May be the default account using \"\".\n"
            "2. \"to" BRAND_lower "address\"  (string, required) The " BRAND_lower " address to send funds to.\n"
...
Value sendmany(const Array& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 4)
        throw runtime_error(
            ...
            "    {\n"
            "      \"address\":amount   (numeric) The " BRAND_lower " address is the key, the numeric amount in ltc is the value\n"
            "      ,...\n"
            "    }\n"
...
Value addmultisigaddress(const Array& params, bool fHelp)
    ...
    if (fHelp || params.size() < 2 || params.size() > 3)
        ...
        string msg = "addmultisigaddress nrequired [\"key\",...] ( \"account\" )\n"
            ...
            "2. \"keysobject\"   (string, required) A json array of " BRAND_lower " addresses or hex-encoded public keys\n"
            "     [\n"
            ...
            "\nResult:\n"
            "\"" BRAND_lower "address\"  (string) A " BRAND_lower " address associated with the keys.\n"
...
Value listtransactions(const Array& params, bool fHelp)
{
    if (fHelp || params.size() > 4)
        throw runtime_error(
            ...
            "    \"address\":\"" BRAND_lower "address\",    (string) The " BRAND_lower " address of the transaction. Not present for \n"
            ...
            "    \"fee\": x.xxx,             (numeric) The amount of the fee in " BRAND_CODE ". This is negative and only available for the \n"
...
Value listsinceblock(const Array& params, bool fHelp)
{
    if (fHelp)
        throw runtime_error(
            ...
            "    \"address\":\"" BRAND_lower "address\",    (string) The " BRAND_lower " address of the transaction. Not present for move transactions (category = move).\n"
...
Value gettransaction(const Array& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "      \"address\" : \"" BRAND_lower "address\",   (string) The " BRAND_lower " address involved in the transaction\n"
...
Value encryptwallet(const Array& params, bool fHelp)
{
    if (!pwalletMain->IsCrypted() && (fHelp || params.size() != 1))
        throw runtime_error(
            ...
            + HelpExampleCli("signmessage", "\"" BRAND_lower "address\" \"test message\"") +
...
Value getwalletinfo(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total " BRAND_lower " balance of the wallet\n"
