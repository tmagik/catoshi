...
static const int64_t nMaxBlockDBAndTxIndexCache = 4096;
...
public:
#if defined(FEATURE_INDEX)
    explicit CBlockTreeDB(size_t nCacheSize, bool fWipe = false, bool compression=true, int maxOpenFiles=1000);
#else
