...
#ifndef CODECOIN_WALLET_WALLET_H
#define CODECOIN_WALLET_WALLET_H
...
#if defined(BRAND_bitcoin) || defined(BRAND_foodchain)
//! -fallbackfee default
...
enum WalletFeature
{
    ...
    FEATURE_NO_DEFAULT_KEY = 151900, // Wallet without a default key written
